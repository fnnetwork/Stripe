...
bot_token = '7295999895:AAGo58OjcmoZhCoeQ74t17U4q5HxyTyN15E'
...
def check_card(card_details, username_tg, session):
    ...
    stripe_data = {
        ...
        'time_on_page': '34062',
        'key': 'pk_live_cc46NYsDduTqxrrjBPWVyhiG'
    }
        ...
        for card in cards:
            ...
            if "Approved" in response:
                ...
                await client.send_message(event.chat_id, response, buttons=[
                    [Button.url("🚀", "https://t.me/"), Button.url("SUPPORT ✨", "https://t.me/fn_network_back")]
                ], link_preview=False)
            else:
